...
2. Select whether you want to play versus computer, against another player locally, or watch the game of engine playing against itself by setting appropriate flags in lines 62 and 63 of `ChessMain.py`.
3. Run `ChessMain.py`.
4. Enjoy the game!
